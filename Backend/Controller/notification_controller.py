...
from Model.NotificationModel import NotificationResponse, NotificationCreate, NotificationUpdate
...
@router.get('/get-active-notification-by-id/{notification_id}', response_model=NotificationResponse)
...
@router.get('/get-active-notification-by-claim-id/{claim_id}', response_model=NotificationResponse)
...
@router.get('/get-active-notifications-by-user/{user_id}', response_model=NotificationResponse)
...
@router.get('/get-unread-notifications-by-user/{user_id}', response_model=NotificationResponse)
...
@router.get('/get-all-active-notifications', response_model=NotificationResponse)
...
@router.delete('/delete-notification/{notification_id}', response_model=NotificationResponse)
def delete_notification(notification_id: int, db: db_dependency) -> NotificationResponse:
