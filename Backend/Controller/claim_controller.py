...
@router.get('/get-active-claim-by-id{claim_id}', response_model=None)
...
@router.get('/get-active-user-by-claim-number{claim_number}', response_model=None)
...
@router.get('/get-active-user-by-policy-id{policy_id}', response_model=None)
...
@router.get('/get-active-by-user-id{user_id}', response_model=None)
...
@router.put('update-claim/{claim_id}', response_model=None)
def update_user (update_request: ClaimUpdate, claim_id: int, db: db_dependency):
    return ClaimService.update_claim(db_session=db, update_request=update_request)


@router.delete('delete-claim/{claim_id}', response_model=None)
